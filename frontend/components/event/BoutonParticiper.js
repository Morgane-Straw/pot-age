...
const BoutonParticiper = (props) => {
    ...
    const sendParticipe = (e) => {
        axios.post(process.env.NEXT_PUBLIC_FRONTEND_ADDRESS + 'api/participer-evenement', { eventId: props.eventId, user: user.id, participe: participe })
    };
