...
import LieuInput2 from "../../recherche/LieuInput2"
...
export default function Page2Event(props) {
    return <>
        ...
        <div className="flex-basis-50 pe-5">
            ...
            <LieuInput2 label="Lieu de l'évenement" id="lieu" placeholder="Entrez l'adresse de votre lieu de rencontre" type="amenity" defaultValue={props.lieu?.properties?.name} setValue={(e)=>props.setLieu(e)}/>
